...
class ModCedSmugMugGalleryHelper
{
    ...
    public function render(&$params)
    {
        ...
        $document->addScript("//cdnjs.cloudflare.com/ajax/libs/nanogallery/4.4.2/jquery.nanogallery.min.js");

        $theme = $params->get('theme', 'default');
        if ($theme == 'default') {
            $document->addStyleSheet("//cdnjs.cloudflare.com/ajax/libs/nanogallery/4.4.2/css/nanogallery.css");
        } else {
            $document->addStyleSheet("//cdnjs.cloudflare.com/ajax/libs/nanogallery/4.4.2/css/themes/$theme/nanogallery_$theme.css");
        }
